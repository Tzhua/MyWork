...
public class Transaction2pcNarayanaXaRawJdbcExampleApplication {
    ...
    static private DataSource getShardingDatasource() throws IOException, SQLException {
        String fileName = "/Users/tzh/IdeaProjects/shardingSphere-jdbc-example/transaction-example/transaction-2pc-narayana-xa-raw-jdbc-example/src/main/resources/sharding-databases-tables.yaml";
